...
ENGINE_ERROR_CODE engine_store(ENGINE_HANDLE * handle,
  ...
  // TODO(amwatson) We currently don't support this check.
  // VBUCKET_GUARD(engine, vbucket);

  cuckoo_status s =
    cuckoo_insert(engine->hash_table, (char *) item, (char *) item);
...
cuckoo_status s = cuckoo_find(engine->hash_table, (char *) key, (char *) *item);
